...
export async function generateMetadata({ params }: { params: Promise<{ slug: string }> }): Promise<Metadata> {
  ...
  return {
    ...
    alternates: { canonical: `https://plantingcalendar.net/blog/${post.slug}/` },
  };
}
...
export default async function Page({ params }: { params: Promise<{ slug: string }> }) {
  ...
  const breadcrumbLd = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 2, name: "Blog", item: "https://plantingcalendar.net/blog/" },
      { "@type": "ListItem", position: 3, name: post.title, item: `https://plantingcalendar.net/blog/${post.slug}/` },
    ],
  };
