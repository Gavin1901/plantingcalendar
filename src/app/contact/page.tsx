...
export const metadata: Metadata = {
  title: "Contact PlantingCalendar (2026) — Get in Touch",
  description: "Contact PlantingCalendar with questions, feedback, bug reports, or collaboration inquiries.",
  alternates: { canonical: "https://plantingcalendar.net/contact/" },
};
...
export default function Page() {
  const breadcrumbLd = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 2, name: "Contact", item: "https://plantingcalendar.net/contact/" },
    ],
  };
