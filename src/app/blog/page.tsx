...
export const metadata: Metadata = {
  title: "Blog — Guides & Tutorials | PlantingCalendar",
  description: "Guides, tutorials and practical tips from PlantingCalendar.",
  alternates: { canonical: "https://plantingcalendar.net/blog/" },
};
...
export default function Page() {
  return (
    <div className="mx-auto max-w-2xl px-5 py-16">
      ...
      <h1 className="mt-6 text-3xl font-bold">PlantingCalendar Blog</h1>
